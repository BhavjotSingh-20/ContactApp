...
//https://reactjs-8962b-default-rtdb.firebaseio.com/
//gs://reactjs-8962b.appspot.com/
...
const AddContact = () => {
  ...
  const updateContact = async () => {
    //TODO: update contact methody
    try {
      firebase.database.ref('contacts/' + contactToUpdateKey).set({name,email,picture:downloadUrl,phoneNumber,address,star})
    } catch(error) {
      console.error(error)
